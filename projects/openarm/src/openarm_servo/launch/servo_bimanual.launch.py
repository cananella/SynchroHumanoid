...
def generate_launch_description():
    ...
    left_servo_params = {
        "moveit_servo": ParameterBuilder("openarm_servo")
        .yaml("config/openarm_left_simulated_config.yaml")
        .to_dict()
    }
    
    right_servo_params = {
        "moveit_servo": ParameterBuilder("openarm_servo")
        .yaml("config/openarm_right_simulated_config.yaml")
        .to_dict()
    }
    ...
    left_servo_params.update(moveit_config.robot_description)
    left_servo_params.update(moveit_config.robot_description_semantic)
    right_servo_params.update(moveit_config.robot_description)
    right_servo_params.update(moveit_config.robot_description_semantic)
    ...
    # Static transform from world to robot base - use body_link0 as the common base
    static_tf_world_to_body = Node(
        package="tf2_ros",
        executable="static_transform_publisher",
        name="static_tf_publisher_world_to_body",
        arguments=["0", "0", "0", "0", "0", "0", "world", "openarm_body_link0"],
        output="screen",
    )
